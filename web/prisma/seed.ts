  ...
  const consultants = [
    await prisma.consultant.create({
      data: {
        ...
        expertiseCompanyTypes: ['mega_venture', 'startup', 'foreign'],
        // Phase 1: 検索用配列フィールド追加
        specialtyIndustries: ['it_internet', 'saas'],
    ...
    await prisma.consultant.create({
      data: {
        ...
        expertiseCompanyTypes: ['large'],
        specialtyIndustries: ['manufacturing', 'finance'],
    ...
    await prisma.consultant.create({
      data: {
        ...
        expertiseCompanyTypes: ['large', 'foreign'],
        specialtyIndustries: ['hr_consulting', 'finance'],
        specialtyJobFunctions: ['hr_recruiting', 'accounting_finance'],
        ageRange: '30s_early',
        education: 'graduate',
    ...
    await prisma.consultant.create({
      data: {
        ...
        expertiseCompanyTypes: ['large', 'startup'],
        specialtyIndustries: ['it_internet', 'saas'],
        specialtyJobFunctions: ['hr_recruiting', 'other'],
        ageRange: '30s_late',
        education: 'university',
        previousIndustry: 'it_internet',
        previousJobFunction: 'hr',
